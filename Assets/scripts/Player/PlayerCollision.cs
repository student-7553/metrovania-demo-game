...
public class PlayerCollision : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        //     {
        //         // left
        //         directionOfKnockBack = new Vector2(-1.2f, 0.8f);
        //     }
        //     else
        //     {
        //         // right
        ...
        //     StartCoroutine(playerMovement.knockBackPlayer(directionOfKnockBack, 10f, 0.2f, null));
    ...
    public void PlayerCollidedWithEnemy(BaseEnemy enemy)
    {
        ...
        StartCoroutine(playerMovement.knockBackPlayer(directionOfKnockBack, 10f, 0.5f, "isGettingKnockedBack"));
