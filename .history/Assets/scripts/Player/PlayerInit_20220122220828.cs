    ...
    void Start()
    {
        ...
        if (checkLastDeath == "death")
        {
            if (GameManager.playerDeathRespawnData != null)
            {
                ...
                Debug.Log("are we getting called in PlayerInit/" + transform.position + "/"+GameManager.playerDeathRespawnData.playerlocation);
        ...
        Debug.Log("are we getting called in PlayerInit/" + transform.position);
